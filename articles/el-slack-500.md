...
**ステップ3：問題が継続する場合はSlak APIサポートに問い合わせる**
...
status.slack.com で障害が報告されていない場合、リクエストのタイムアウト（サーバーからの応答待機時間の上限）設定を確認してください。ネットワーク遅延でタイムアウトになり、結果として500エラーに見えることがあります。
